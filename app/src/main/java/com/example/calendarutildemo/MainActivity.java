...
public class MainActivity extends AppCompatActivity {
    ...
    private void addCalender(){
        Observable.create(new ObservableOnSubscribe<Boolean>() {
            ...
            public void subscribe(ObservableEmitter<Boolean> e) throws Exception {
                CalendarReminderUtils.deleteCalendarEvent(MainActivity.this, TITLE);
                String[] dayList = new String[]{"20210814", "20210815", "20210816", "20210817", "20210818", "20210819", "20210820"};
                // 用户同意的授权请求
                for (String day : dayList) {

                    for (int i =0;i<24;i=i+2){
                        long dayms = getMsFromDayTime(Integer.parseInt(day.substring(0, 4)), Integer.parseInt(day.substring(4, 6)) - 1, Integer.parseInt(day.substring(6, 8)), i, 00);
